...
function waitForStackCreateComplete() {
	...
	aws cloudformation wait stack-update-complete --stack-name $1 --region eu-west-1 --profile $2
...
aws cloudformation update-stack --stack-name 'devops-01-prereqs' \
...
aws cloudformation update-stack --stack-name 'devops-02-cf-roles' \
...
aws cloudformation update-stack --stack-name 'devops-03-artifact-bucket-policy' \
